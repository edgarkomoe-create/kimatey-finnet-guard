...
const I18N = {
  fr: {
    ...
    how3_tag: "🧪 Prototype",
    how3_h3: "Fraude Transactionnelle",
    how3_p: "Un second modèle, même méthodologie, évalue si une transaction mobile money (montant, fréquence, destinataire) ressemble à un comportement frauduleux. Entraîné sur des données synthétiques - démontre la capacité d'extension à un nouveau domaine.",
    how3_s1: "Même pipeline que le modèle réseau",
    how3_s2: "Score de sécurité et journal dédiés",
    how3_s3: "Données synthétiques, clairement étiquetées",

    // ---- Espaces ----
    spaces_eyebrow: "La plateforme",
    spaces_h2: "Choisissez votre espace",
    card_org_h3: "🏢 Espace Organisation",
    card_org_p: "Deux modules : Sécurité Réseau (validé) et Fraude Transactionnelle (prototype). Dashboard SOC animé, journal d'alertes persistant, réglages de sensibilité. Compte requis - pour les équipes IT/sécurité des fintechs, opérateurs mobile money et institutions financières.",
    ...
    card_academic_h3: "🎓 Espace Académique",
    card_academic_p: "Cas d'étude pédagogique : explications, Professeur Cyber en Q&A, mini-quiz, import de jeu de données. Libre d'accès, aucun compte requis - pour enseignants et étudiants.",
    card_academic_cta: "Entrer dans l'Espace Académique →",
  ...
  en: {
    ...
    how3_tag: "🧪 Prototype",
    how3_h3: "Transaction Fraud",
    how3_p: "A second model, same methodology, evaluates whether a mobile money transaction (amount, frequency, recipient) resembles fraudulent behavior. Trained on synthetic data - demonstrates the ability to extend to a new domain.",
    how3_s1: "Same pipeline as the network model",
    how3_s2: "Dedicated security score and log",
    how3_s3: "Synthetic data, clearly labeled",

    spaces_eyebrow: "The platform",
    spaces_h2: "Choose your space",
    card_org_h3: "🏢 Organization Space",
    card_org_p: "Two modules: Network Security (validated) and Transaction Fraud (prototype). Animated SOC dashboard, persistent alert log, sensitivity settings. Account required - for IT/security teams at fintechs, mobile money operators, and financial institutions.",
    ...
    card_academic_h3: "🎓 Academic Space",
    card_academic_p: "Educational case study: explanations, Professor Cyber Q&A, mini-quiz, dataset import. Free access, no account required - for teachers and students.",
    card_academic_cta: "Enter the Academic Space →",
