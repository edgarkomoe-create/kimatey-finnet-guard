...
const I18N = {
  fr: {
    ...
    game_note: "Mécanique de gamification inspirée de l'Espace Jeux VIE (VIE Water Care) - niveaux, Points Bouclier, vies, catégories thématiques - adaptée à la fraude mobile money, avec Lieutenant Cyber (l'IA propre à Kimatey FinNet Guard, une création originale) comme guide. Les Points Bouclier n'ont aucune valeur monétaire ni conversion en argent réel : un indicateur de progression et de vigilance, point. Contrairement à l'application Streamlit de l'Espace Organisation, votre progression ici est mémorisée dans votre navigateur (pas de compte requis) et survit à une fermeture de la page.",
  ...
  en: {
    ...
    game_note: "Gamification mechanics inspired by the VIE Games Space (VIE Water Care) - levels, Shield Points, lives, themed categories - adapted to mobile money fraud, with Lieutenant Cyber (Kimatey FinNet Guard's own AI, an original creation) as guide. Shield Points have no monetary value and cannot be converted to real money: a progress and vigilance indicator, nothing more. Unlike the Organization's Streamlit app, your progress here is stored in your browser (no account needed) and survives closing the page.",
